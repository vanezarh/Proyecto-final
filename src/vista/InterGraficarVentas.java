...
public class InterGraficarVentas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Gráfica del Historial de Ventas ");
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(550, 650));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-2, -2, 540, 620));
